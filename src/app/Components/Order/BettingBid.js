...
import SwipeButton from "../wallet/SwiperButton";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center text-white p-4">
              ...
              >
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() => setSelectedBid(bid.put)} 
                    className="hidden"
                  />
      ...
      <div className="w-full max-w-md flex flex-col items-center mt-6">
        <div className="w-full rounded-full bg-[#2C2B2B]">
        <SwipeButton selectedOption={selectedOption} />
        </div>
