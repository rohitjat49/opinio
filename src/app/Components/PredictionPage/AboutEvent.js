...
// import NoButton from "@/app/ui/NoButton";
// import YesButton from "@/app/ui/YesButton";
// import { ChevronRight } from "lucide-react";

// const AboutEvent = () => {
//   return (
//     <div className="bg-black text-white p-8 rounded-lg w-full max-w-lg mx-auto space-y-6">
//       {/* About the Event Section */}
