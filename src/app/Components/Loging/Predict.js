  ...
  return (
    <div className="h-screen w-full flex flex-col items-center bg-black text-white px-4">
      ...
      <div className="relative w-[440px] max-w-full flex justify-center">
        <Image
          src="/Image/Frame 14 (1).png" // Replace with your actual image path
          alt="Predict Image"
          width={440}
          height={250}
      ...
      <div className="mt-6 text-center">
        <h2 className="text-lg font-semibold">Make Prediction</h2>
        <p className="text-sm text-gray-400">Test your instincts and forecast the future.</p>
      </div>
